using Catálogo_de_jogos_usando_.NET.Controllers.V1;
using Catálogo_de_jogos_usando_.NET.Middleware;
using Catálogo_de_jogos_usando_.NET.Repositories;
using Catálogo_de_jogos_usando_.NET.Services;
...
namespace Catálogo_de_jogos_usando_.NET
{
